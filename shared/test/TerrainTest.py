...
class TerrainTest(unittest.TestCase):
    ...
    def test_mountain_terrain_type_returns_none_for_movement_cost(self):
        self.terrain = Terrain("mountain", "tundra")
        self.assertEqual(self.terrain.movement_cost, None)

    def test_ocean_terrain_type_returns_none_for_movement_cost(self):
