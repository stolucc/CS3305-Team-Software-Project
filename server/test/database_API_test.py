...
class SimpleDatabaseTest(unittest.TestCase):
    ...
    def test_select_user(self):
        ...
        game_id = Game.insert_game(session, 1, True)
        user_id = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        user_dict = User.select_user(session, user_id)
    ...
    def test_update_user(self):
        ...
        game_id = Game.insert_game(session, 1, True)
        user_id = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        User.update_user(session, user_id, game_id=game_id, active=False,
    ...
    def test_select_technology(self):
        ...
        user_id = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        Technology.insert_technology(session, user_id, 1)
        technology_dict = Technology.select_technology(session, user_id, 1)
    ...
    def test_update_technology(self):
        ...
        game_id = Game.insert_game(session, 1, True)
        user_id1 = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        user_id2 = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        Technology.insert_technology(session, user_id1, 1)
        Technology.update_technology(session, user_id1, 1,
                                     user_id=user_id2, technology_id=2)
        technology_dict = Technology.select_technology(session, user_id2, 2)
    ...
    def test_select_unit(self):
        ...
        user_id = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        unit_id = Unit.insert_unit(session, user_id, 0, 100, 0, 0, 0)
        unit_dict = Unit.select_unit(session, unit_id)
    ...
    def test_update_unit(self):
        ...
        user_id1 = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        user_id2 = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        unit_id = Unit.insert_unit(session, user_id1, 0, 100, 0, 0, 0)

        Unit.update_unit(session, unit_id, user_id=user_id2, type=1,
    ...
    def test_select_building(self):
        ...
        user_id = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        building_id = Building.insert_building(session, user_id, 0, 0, 0, 0)
        building_dict = Building.select_building(session, building_id)
    ...
    def test_update_building(self):
        ...
        user_id1 = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        user_id2 = User.insert_user(session, game_id, True, 0, 0, 0, 0)
        building_id = Building.insert_building(session, user_id1, 0, 0, 0, 0)

        Building.update_building(session, building_id, user_id=user_id2,
                                 type=1, x=3, y=-2, z=-1)
        building_dict = Building.select_building(session, building_id)
